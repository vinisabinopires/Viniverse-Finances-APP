...
import { Download, Upload, Trash2, Info, Shield, AlertTriangle } from "lucide-react";
  ...
  const handleExport = async () => {
    try {
      ...
      toast({
        ...
        description: `Saved as viniverse-finances-backup-${today}.json`,
      });
    } catch {
        ...
        {showDeleteConfirm && (
          <div className="glass-card rounded-2xl p-5 border border-rose-500/20 bg-rose-500/5 space-y-4">
            ...
            <div className="flex gap-2">
              <Button
                variant="outline"
                onClick={() => { setShowDeleteConfirm(false); setDeleteInputValue(""); }}
              ...
              <Button
                ...
                className="flex-1 bg-rose-500 hover:bg-rose-600 text-white disabled:opacity-40"
