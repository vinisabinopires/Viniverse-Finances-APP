      ...
      <div className="p-4 space-y-5 pt-12 pb-8">
        ...
        <div className="space-y-2">
          ...
          <div className="glass-card rounded-2xl overflow-hidden divide-y divide-white/10 border border-white/10">
            ...
            <Link href="/goals" className="w-full p-4 flex items-center gap-3 hover:bg-white/5 transition-colors">
              <div className="w-9 h-9 rounded-xl bg-emerald-500/10 flex items-center justify-center flex-shrink-0">
                <Target className="w-4 h-4 text-emerald-400" />
              </div>
              <div className="flex-1">
                <h3 className="font-medium text-sm">Financial Goals</h3>
                <p className="text-xs text-muted-foreground">Track savings targets and milestones</p>
              </div>
              <ChevronRight className="w-4 h-4 text-muted-foreground/50" />
            </Link>
          </div>
